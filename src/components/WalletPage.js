...
const WalletPage = () => {
  ...
  const transactions = [
    { id: 1, description: "Bought Groceries", amount: -2000 },
    { id: 2, description: "Received Salary", amount: +40000 },
    { id: 3, description: "Paid Electricity Bill", amount: -3500 },
    { id: 4, description: "Transferred to Savings", amount: -10000 },
